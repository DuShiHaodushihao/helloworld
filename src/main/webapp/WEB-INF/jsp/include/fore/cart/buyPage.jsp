            ...
            <div>
                <table class="addressTable">
                    <tr>
                        ...
                        <td><textarea name="address" placeholder="建议您如实填写详细收货地址，例如街道名称"></textarea> </td>
                    </tr>
                    <tr>
                        <td>邮政编码</td>
                    ...
                    <tr>
                        ...
                        <td><input name="mobile" placeholder="请输入11位手机号" type="text"> </td>
                    </tr>
                </table>
            </div>
        </div>
        <div class="productList">
                    ...
                    <tr class="orderItemTR">
                        ...
                        <c:if test="${st.count==1}">
                            <td rowspan="5" class="orderItemLastTD">
                                <label label="orderItemDeliveryLabel">
            ...
            <div class="orderItemSumDiv">
                <div class="pull-left">
                    ...
                    <span>
                        <img src class="leaveMessageImg" src="img/site/leaveMessage.png">
                    </span>
                ...
                <span class="pull-rigth">店铺合计（含运费）：￥<fmt:formatNumber type="number" value="${total}" minFractionDigits="2"/> </span>
            </div>
        </div>
