            ...
            <div class="productUnit" price="${p.promotePrice}">
                <div class="productUnitFrame">
                    <a href="foreproduct?pid=${p.id}">
                        <img class="productImage" src="img/productSingle_middle/${p.firsProductImage.id}.jpg">
                    </a>
                    ...
                    <div class="show1 productInfo">
                        <span class="productReview">评价<span class="productReviewNumber">${p.saleCount}笔</span></span>
