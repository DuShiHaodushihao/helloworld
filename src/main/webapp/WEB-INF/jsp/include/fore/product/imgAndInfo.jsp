<%@ page language="java" contentType="text/html; charset" pageEncoding="UTF-8" isELIgnored="false" %>
<script>
    $(function(){
        var stock=${p.stock};
        $(".productNumberSettin").keyup(function () {
                        ...
                        $.get(
                            ...
                            function (result) {
                                if("success"==result){
                                    ...
                                    $(".addCartButton").css("boder-color","lightgray");
